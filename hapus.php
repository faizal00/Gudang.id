      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item has-treeview menu-open">
                <a href="./hapus.php" class="nav-link active">
    ...
    <section class="content">
        ...
        while($barang = mysqli_fetch_array($query)){
          $noUrut++;
            ...
            echo "<td><form action='proses-hapus.php' method='POST'><input type='hidden' name='id' value=".$barang['id']."><button class='btn btn-danger' type='submit' name='hapus'>Hapus</button></form></td>";
            echo "</tr>";
            echo "";
