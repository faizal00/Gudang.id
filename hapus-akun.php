      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item has-treeview menu-open">
                <a href="./hapus-akun.php" class="nav-link active">
    ...
    <section class="content">
        ...
        while($user = mysqli_fetch_array($query)){
          $noUrut++;
            ...
            echo "<td><form action='proses-hapus-akun.php' method='POST'><input type='hidden' name='Id' value=".$user['Id']."><button class='btn btn-danger' type='submit' name='hapus-akun'>Hapus</button></form></td>";
            echo "</tr>";
            echo "";
